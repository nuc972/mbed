...
static int32_t CLK_IsRTCClockEnabled_Impl(void)
{
...
__NONSECURE_ENTRY
int32_t CLK_IsRTCClockEnabled_Veneer(uint32_t arg0, uint32_t arg1, uint32_t arg2, uint32_t arg3)
{
    int32_t *clk_en = (int32_t *) arg0;
    *clk_en = CLK_IsRTCClockEnabled_Impl();
    return 0;
}
...
{
    nu_tfm_ns_lock_dispatch(SYS_ResetModule_Veneer, u32ModuleIndex, 0, 0, 0);
}

void CLK_SetModuleClock_S(uint32_t u32ModuleIndex, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    nu_tfm_ns_lock_dispatch(CLK_SetModuleClock_Veneer, u32ModuleIndex, u32ClkSrc, u32ClkDiv, 0);
}

void CLK_EnableModuleClock_S(uint32_t u32ModuleIndex)
{
    nu_tfm_ns_lock_dispatch(CLK_EnableModuleClock_Veneer, u32ModuleIndex, 0, 0, 0);
}

void CLK_DisableModuleClock_S(uint32_t u32ModuleIndex)
{
    nu_tfm_ns_lock_dispatch(CLK_DisableModuleClock_Veneer, u32ModuleIndex, 0, 0, 0);
}

int32_t CLK_IsRTCClockEnabled_S(void)
{
    int32_t clk_en = 0;
    nu_tfm_ns_lock_dispatch(CLK_IsRTCClockEnabled_Veneer, (uint32_t) &clk_en, 0, 0, 0);
    return clk_en;
}

void SYS_LockReg_S(void)
{
    nu_tfm_ns_lock_dispatch(SYS_LockReg_Veneer, 0, 0, 0, 0);
}

void SYS_UnlockReg_S(void)
{
    nu_tfm_ns_lock_dispatch(SYS_UnlockReg_Veneer, 0, 0, 0, 0);
}

void nu_idle_s(void)
{
    nu_tfm_ns_lock_dispatch(nu_idle_veneer, 0, 0, 0, 0);
}

void nu_powerdown_s(void)
{
    nu_tfm_ns_lock_dispatch(nu_powerdown_veneer, 0, 0, 0, 0);
}
...
int32_t CLK_IsRTCClockEnabled_S(void)
{
    return CLK_IsRTCClockEnabled_Impl();
}
